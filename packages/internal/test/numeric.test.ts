...
describe("price amount helpers", () => {
  test("converts whole sats to bigint millisatoshis", () => {
    expect(sats(0)).toBe(0n);
    expect(sats(1)).toBe(1_000n);
    expect(sats(21_000_000n * 100_000_000n)).toBe(2_100_000_000_000_000_000n);
  });
...
describe("satsToMsats", () => {
  test("converts whole sats to msats", () => {
    ...
    expect(satsToMsats(21_000_000n * 100_000_000n)).toBe(2_100_000_000_000_000_000n);
  });

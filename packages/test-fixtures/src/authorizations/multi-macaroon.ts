...
// Per the active plan and L402 protocol-specification.md §5, multiple
// macaroons in one credential are FIRST-CLASS in the grammar:
...
export const multiMacaroonAuthorizationFixtures: AuthorizationFixture[] = [
  {
    ...
    source: "L402 protocol-specification.md §5 (multi-macaroon credential)",
  ...
  {
    name: "two-macaroons-with-whitespace-around-comma",
    source: "L402 protocol-specification.md §5 (whitespace-tolerant tokenization, hand-authored)",
    header: `L402 ${SPEC_EXAMPLE_MACAROON} , ${SPEC_EXAMPLE_MACAROON_2} : ${SPEC_EXAMPLE_PREIMAGE}`,
    expected: {
      ok: true,
      fields: {
  ...
  },
  {
    ...
    source: "L402 protocol-specification.md §5 (multi-macaroon, hand-authored)",
